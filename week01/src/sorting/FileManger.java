...
public class FileManger {
    ...
    public ArrayList<Integer> readFile() throws IOException {
        Scanner scanner = new Scanner(new File("week01/src/sorting/" + this.inputFileName));
    ...
    public void writeFile(ArrayList<Integer> outputArray) throws IOException {
        FileOutputStream fileOutputStream = new FileOutputStream(new File("week01/src/sorting/" + this.outputFileName));
        fileOutputStream.close();
        FileWriter fileWriter = new FileWriter(new File("week01/src/sorting/" + this.outputFileName));
